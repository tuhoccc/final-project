...
const OptionsSetting: React.FC = () => {
    ...
    const [isSettingCurrency, setIsSettingCurrency] = useState(false);
    const [isSettingLanguage, setIsSettingLanguage] = useState(false);
    const [isSettingRequest, setIsSettingRequest] = useState(false);
        ...
        <div className="py-[16px] flex justify-center" >
            <div className="hidden md:block border-[1px] rounded"
                ...
                <Link to="/setting/" onMouseEnter={() => setHoverPersonal(true)} onMouseLeave={() => setHoverPersonal(false)} className="flex justify-start border-b-[1px]  w-[306px] p-[16px] items-center hover:underline decoration-[#006ce4] hover:text-[#006ce4] hover:cursor-pointer">
                    ...
                    <span className="ms-2 leading-[20px] text-[14px] leading-[20px] text-[14px]" >Personal information</span> </Link>
                <div onMouseEnter={() => setHoverOptions(true)} onMouseLeave={() => setHoverOptions(false)} className="flex justify-start border-b-[1px]  w-[306px] p-[16px] items-center hover:underline decoration-[#006ce4] text-[#006ce4] hover:cursor-pointer">
                    <span className="rounded-full bg-[#f5f5f5] p-[10px]">
                        <svg className="size-[16px] " fill="#006ce4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-rtl-flip="true"><path d="M.75 4.5h16.34a3.5 3.5 0 1 0 0-1.5H.75a.75.75 0 0 0 0 1.5M20.5 1.75a2 2 0 1 1-2 2 2 2 0 0 1 2-2m2.75 17.75H9.46a3.5 3.5 0 0 0-6.83 0H.75a.75.75 0 0 0 0 1.5h1.88a3.5 3.5 0 0 0 6.83 0h13.79a.75.75 0 0 0 0-1.5m-17.2 2.75a2 2 0 1 1 2-2 2 2 0 0 1-2 2M23.25 11h-7.84a3.49 3.49 0 0 0-6.82 0H.75a.75.75 0 0 0 0 1.5h7.84a3.49 3.49 0 0 0 6.82 0h7.84a.75.75 0 0 0 0-1.5M12 13.75a2 2 0 1 1 2-2 2 2 0 0 1-2 2"></path></svg>
                    </span>
                    <span className="ms-2 leading-[20px] text-[14px]">Options</span></div>
            ...
            <div className="max-w-[808px] ms-5"
                style={{ fontFamily: 'BlinkMacSystemFont,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif' }}>
                <div className="text-[32px] leading-[40px] font-[700] ">Options</div>
                <div className="text-[16px] leading-[24px] text-[#595959] my-2 pb-2">
                    Change language, currency, and disability support requirements.
                </div>
                <div className="mb-10 me-2 md:me-0">
                    {
                        !isSettingCurrency && <div className="border-t-[1px] border-gray-900/20 py-4 md:flex md:items-center md:grid md:grid-cols-5">
                            <div className="leading-[20px] text-[16px] text-[#1a1a1a] ms-4">Currency</div>
                            <div className="col-span-3 leading-[16px] text-[14px] text-[#1a1a1a] ms-4 md:ms-0" >VND</div>
                            <div onClick={() => {
                                if (!isSetting) {
                                    setIsSettingCurrency(true)
                                    setIsSetting(true)
                                }
                            }} className={isSetting ? "md:text-center text-end text-[14px] font-[500] leading-[20px] text-[#a2a2a2] hover:cursor-not-allowed" : "md:text-center text-end text-[14px] font-[500] leading-[20px] text-[#006ce4] hover:underline decoration-[#006ce4] hover:cursor-pointer"}>Edit</div>
                        </div>
                    }

                    {isSettingCurrency && <div className="border-t-[1px] border-gray-900/md:20 py-4 md:flex md:grid md:grid-cols-5">
                        <div className="leading-[20px] text-[16px] text-[#1a1a1a] ms-4">Currency</div>
                        <div className="col-span-3  pb-[50px]" >
                            <div className="md:ms-0 ms-4">
                                <div className="mb-1 text-[14px] font-[500] leading-[20px]">Currency</div>
                                <select name="" className={currencyValue == "" ? "py-[3px]  rounded text-[#595959]" : "py-[3px] rounded"} onChange={(e) => setCurrencyValue(e.target.value)} id="">
                                    <option value="" className="text-[#595959]">Select currency</option>
                                    <option className="text-[#595959]" value="VND">VND</option>
                                    <option className="text-[#595959]" value="Yen">Yen</option>
                                </select>
                            </div>
                        </div>
                    ...
                    {
                        !isSettingLanguage && <div className="border-t-[1px] border-gray-900/md:20 py-4 md:flex md:grid md:grid-cols-5">
                            <div className="leading-[20px] text-[16px] text-[#1a1a1a] ms-4">Language</div>
                            <div className="col-span-3 leading-[16px] text-[14px] text-[#595959] ms-4 md:ms-0" >Select language</div>
                            <div onClick={() => {
                                if (!isSetting) {
                    ...
                    {isSettingLanguage && <div className="border-t-[1px] border-gray-900/md:20 py-4 md:flex md:grid md:grid-cols-5">
                        ...
                        <div className="col-span-3  pb-[50px]" >
                            <div className="ms-4 md:ms-0">
                                <div className="mb-1 text-[14px] font-[500] leading-[20px]">Language <span className="text-[#d4111e]">*</span></div>
                                <select name="" className={languageValue == "" ? "py-[3px]  rounded text-[#595959]" : "py-[3px] rounded"} onChange={(e) => setLanguageValue(e.target.value)} id="">
                                    <option value="" className="text-[#595959] ">Select language</option>
                                    <option className="text-[#595959]" value="Vietnamese">Vietnamese</option>
                                    <option className="text-[#595959]" value="English">English</option>
                                </select>
                            </div>
                        </div>
                        <div className="flex justify-between ms-4 md:ms-0 md:justify-center md:content-between md:grid  h-full">
                    ...
                    {
                        !isSettingRequest && <div className="border-y-[1px] border-gray-900/md:20 py-4 md:flex md:grid md:grid-cols-5">
                            <div className="leading-[20px] text-[16px] text-[#1a1a1a] ms-4 md:ms-4">Request disability support</div>
                            <div className="col-span-3 leading-[16px] text-[14px] text-[#1a1a1a]" >
                                <div className="text-[#595959] md:ms-0 ms-4" >Filter and eliminate properties that don't meet your needs</div>
                            </div>
                            <div onClick={() => {
                                if (!isSetting) {
                                    setIsSettingRequest(true)
                                    setIsSetting(true)
                                }
                            }} className={isSetting ? "md:text-center text-end text-[14px] font-[500] leading-[20px] text-[#a2a2a2] hover:cursor-not-allowed" : "md:text-center text-end text-[14px] font-[500] leading-[20px] text-[#006ce4] hover:underline decoration-[#006ce4] hover:cursor-pointer"}>Edit</div>
                        </div>
                    ...
                    {isSettingRequest && <div className="border-y-[1px] border-gray-900/md:20 py-4 md:flex md:grid md:grid-cols-5">
                        <div className="leading-[20px] text-[16px] text-[#1a1a1a] ms-4">Request disability support</div>
                        <div className="col-span-3 pb-[50px]" >
                            <div className="flex items-center md:ms-0 ms-4" >
                                <input className="text-[14px] leading-[20px] me-2 py-[3px] rounded" type="checkbox" />
                                <div className="text-[14px] font-[500] leading-[20px]">Show only accessible properties </div>
                            </div>
                        </div>
                        <div className="flex justify-between ms-4 md:ms-0 md:justify-center md:content-between md:grid  h-full">
                            <div onClick={() => {
                                setIsSettingRequest(false)
                                setIsSetting(false)
                            }} className="flex justify-center text-[14px] font-[500] leading-[20px] text-[#006ce4] hover:underline decoration-[#006ce4] hover:cursor-pointer">Cancel</div>
                            <div className="flex justify-center ">
                                <span className="text-center rounded px-[12px] py-[4px] hover:cursor-pointer text-[14px] font-[500] leading-[20px] text-white bg-[#006ce4]">Save</span>
