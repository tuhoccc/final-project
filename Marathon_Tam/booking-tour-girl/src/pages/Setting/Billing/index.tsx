    ...
    return (
        <div className="py-[16px] flex justify-center" >
            ...
            <div className="max-w-[808px] ms-5"
                style={{ fontFamily: 'BlinkMacSystemFont,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif' }}>
                <div className="text-[32px] leading-[40px] font-[700] ">Billing Information</div>
                <div className="text-[16px] leading-[24px] text-[#595959] my-2 pb-2">
                    Add or remove payment methods securely for easier ordering.
                </div>
                <div className="mb-10">
                    <div className="border-y-[1px] border-gray-900/20 py-4 md:flex md:grid md:grid-cols-5">
                        <div className="leading-[20px] text-[16px] text-[#1a1a1a] ms-4">Payment card</div>
                        <div className="col-span-3 leading-[16px] text-[14px] text-[#1a1a1a]" >
                            <div className="mb-2 ms-4 md:ms-0">Pay with new card</div>
                        </div>
                        <div onClick={() => {
                            if (!isSetting) {
                                setIsSetting(true)
                            }
                        }} className={isSetting ? "md:text-center text-end me-4 ms:me-0 text-[14px] font-[500] leading-[20px] text-[#a2a2a2] hover:cursor-not-allowed" : "md:text-center text-end me-4 ms:me-0 text-[14px] font-[500] leading-[20px] text-[#006ce4] hover:underline decoration-[#006ce4] hover:cursor-pointer"}>Add card</div>
                    </div>
                </div>
