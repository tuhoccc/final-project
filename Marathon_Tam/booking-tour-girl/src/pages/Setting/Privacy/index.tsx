    ...
    return (
        <div className="py-[16px] flex justify-center" >
            ...
            <div className="max-w-[808px] ms-5"
                style={{ fontFamily: 'BlinkMacSystemFont,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif' }}>
                <div className="text-[32px] leading-[40px] font-[700] ">Privacy</div>
                <div className="text-[16px] leading-[24px] text-[#595959] my-2 pb-2">
                    Exercise privacy and control how your data is used.
                </div>
                <div className="mb-10">
                    <div className="border-y-[1px] border-gray-900/20 py-4 md:flex md:grid md:grid-cols-5">
                        <div className="leading-[20px] text-[16px] text-[#1a1a1a] ms-4">Privacy settings</div>
                        <div className="col-span-3 leading-[16px] text-[14px] text-[#1a1a1a]" >
                            <div className="mb-2 ms-4 md:ms-0">
                                trannguyen.06042002@gmail.com</div>
                            <div className="mb-2 text-[#595959] ms-4 md:ms-0">Select "Manage" to change your privacy settings and exercise your rights via our request form.</div>
                        </div>
                        <div onClick={() => {
                            if (!isSetting) {
                                setIsSetting(true)
