...
const CompanionSetting: React.FC = () => {
    ...
    return (
        <div className="py-[16px] flex justify-center" >
            <div className="hidden md:block border-[1px] rounded"
                ...
                <div
                    onMouseEnter={() => setHoverCompanion(true)} onMouseLeave={() => setHoverCompanion(false)} className="flex justify-start border-b-[1px]  w-[306px] p-[16px] items-center hover:underline decoration-[#006ce4] text-[#006ce4] hover:cursor-pointer">
                    <span className="rounded-full bg-[#f5f5f5] p-[10px]">
                    ...
                    <span className="ms-2 leading-[20px] text-[14px]">Companion</span></div >
            </div >
            <div className="max-w-[808px] ms-5"
                style={{ fontFamily: 'BlinkMacSystemFont,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif' }}>
                <div className="text-[32px] leading-[40px] font-[700] ">Companion</div>
                <div className="text-[16px] leading-[24px] text-[#595959] my-2 pb-2">
                    Add or edit information for people you're traveling with.
                </div>
                <div className="relative mb-10">
                    <span className="absolute right-2 rounded px-[12px] py-[8px] hover:cursor-pointer text-[14px] font-[500] leading-[20px] text-white bg-[#006ce4] hover:opacity-80">
                        <i className="me-1 fa fa-plus text-[#fff]/50" aria-hidden="true"></i>
                        Add more people</span>
