    ...
    return (
        <div className="py-[16px] flex justify-center" >
            <div className="hidden md:block border-[1px] rounded"
                ...
                <div
                    onMouseEnter={() => setHoverEmail(true)} onMouseLeave={() => setHoverEmail(false)} className="flex justify-start border-b-[1px]  w-[306px] p-[16px] items-center hover:underline decoration-[#006ce4] text-[#006ce4] hover:cursor-pointer">
                    <span className="rounded-full bg-[#f5f5f5] p-[10px]">
                        <svg className="size-[16px] " fill={"#006ce4"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M9.28 21.961a2.837 2.837 0 0 0 5.445 0 .75.75 0 1 0-1.44-.422 1.337 1.337 0 0 1-2.565 0 .75.75 0 1 0-1.44.422M12.75 3V.75a.75.75 0 0 0-1.5 0V3a.75.75 0 0 0 1.5 0m-.75.75a6.75 6.75 0 0 1 6.75 6.75c0 3.154.29 5.436.785 6.994.323 1.02.684 1.59.995 1.84L21 18H3l.59 1.212c.248-.315.572-.958.88-2 .49-1.66.78-3.872.78-6.712A6.75 6.75 0 0 1 12 3.75m0-1.5a8.25 8.25 0 0 0-8.25 8.25c0 2.702-.272 4.772-.72 6.288-.254.864-.493 1.336-.62 1.5A.75.75 0 0 0 3 19.5h18c.708 0 1.022-.892.47-1.335.019.016-.008-.015-.07-.113-.14-.223-.29-.553-.435-1.012-.443-1.396-.715-3.529-.715-6.54A8.25 8.25 0 0 0 12 2.25"></path></svg>
                    </span>
                    <span className="ms-2 leading-[20px] text-[14px]">Email notification</span></div >
            ...
            <div className="max-w-[808px] ms-5"
                style={{ fontFamily: 'BlinkMacSystemFont,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif' }}>
                <div className="text-[32px] leading-[40px] font-[700] ">Email Notification</div>
                <div className="text-[16px] leading-[24px] text-[#595959] my-2 pb-2">
                    Choose what you get notified about and turn off unnecessary notifications.
                </div>
                <div className="mb-10">
                    <div className="border-y-[1px] border-gray-900/20 py-4 md:flex md:grid md:grid-cols-5">
                        <div className="leading-[20px] text-[16px] text-[#1a1a1a] ms-4">Email Options</div>
                        <div className="col-span-3 leading-[16px] text-[14px] text-[#1a1a1a]" >
                            <div className="mb-2 md:ms-0 ms-4">
                                trannguyen.06042002@gmail.com</div>
                            <div className="mb-2 text-[#595959] md:ms-0 ms-4">This is the email address you use to log in. We will also send booking confirmations to this address.</div>
                        </div>
                        <div onClick={() => {
                            if (!isSetting) {
                                setIsSetting(true)
                            }
                        }} className={isSetting ? "md:text-center text-end md:me-0 me-4 text-[14px] font-[500] leading-[20px] text-[#a2a2a2] hover:cursor-not-allowed" : "md:text-center text-end md:me-0 me-4 text-[14px] font-[500] leading-[20px] text-[#006ce4] hover:underline decoration-[#006ce4] hover:cursor-pointer"}>Manage</div>
                    </div>
                </div>
